    ...
    **/
    ...
    function setMarkerContent(data, lat, long){
        ...
        var content = `
            ...
            <div>mit einer berechneten Bodentemperatur von: ${parseFloat(data.soil_temp).toFixed(2)}°C in einer Tiefe von ${parseFloat(data.depth_level).toFixed(2)} m.</div>
            <div>Die angenommene Lufttemperatur:  ${parseFloat(data.air_temp).toFixed(2)}°C für das Datum: ${data.date}.</div>
            <div>Aktuelle Temperaturen finden sie auf der DWD Webseit
